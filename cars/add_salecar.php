...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO carsale (car_name, car_image, brand,fuel_type,model,info, price) VALUES ('$car_name', '$car_image', '$brand','$fuel','$model','$info', '$price_per_day')";

    if ($conn->query($sql) === TRUE) {?>
		<script type="text/javascript">
            window.alert("successfully Car Added");
            window.location="add_salecar.php";
            </script>
			<?php } else {
...
<div id="login-btn">
   <a href="logout.php"><button class="btn">Logout</button></a>
    ...
    <div class="admin-dashboard">
        ...
        <h1 style="font-size:30px;">Add Car For Sale</h1>
            ...
            <select name="fuel" class="input-field" required>
            ...
            <select name="model" class="input-field" required>
                ...
                // Get current year
                $current_year = date("Y");
                // Display years from 10 years ago to current year
                for ($i = $current_year - 15; $i <= $current_year; $i++) {
